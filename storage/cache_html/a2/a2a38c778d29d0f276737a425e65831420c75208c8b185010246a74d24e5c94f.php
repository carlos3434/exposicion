...
/* invoice.html.twig */
class __TwigTemplate_47ba97540f155eb40a443196b411bbc6125a2b2d9281eb4284c4115cf1837f82 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <tbody><tr>
        ...
        echo "                            </tbody>
            ...
            ";
        // line 307
        if (((isset($context["max_items"]) || array_key_exists("max_items", $context)) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["doc"]) || array_key_exists("doc", $context) ? $context["doc"] : (function () { throw new RuntimeError('Variable "doc" does not exist.', 307, $this->source); })()), "details", [], "any", false, false, false, 307)), (isset($context["max_items"]) || array_key_exists("max_items", $context) ? $context["max_items"] : (function () { throw new RuntimeError('Variable "max_items" does not exist.', 307, $this->source); })()))))) {
            // line 308
...
";
    ...
    {
        return new Source("", "invoice.html.twig", "/var/www/cmvp/vendor/greenter/report/src/Report/Templates/invoice.html.twig");
    }
}
